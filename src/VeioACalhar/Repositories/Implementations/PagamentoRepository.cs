...
public class PagamentoRepository : IPagamentoRepository
{
    ...
    public PagamentoRepository(ISqlCommandFactory commandFactory, IParcelaRepository parcelasRepository, IFormaPagamentoRepository formaPagamentoRepository, IPessoaRepository<PessoaGenerica> pessoaRepository)
    {
    ...
    {
        using var command = commandFactory.Create("INSERT INTO Pagamentos(Id_Pagador, Id_Favorecido, Id_Forma_Pagamento) OUTPUT INSERTED.Id VALUES (@Id_Pagador, @Id_Favorecido, @Id_Forma_Pagamento)");
    ...
    {
        using var command = commandFactory.Create("UPDATE Pagamentos SET Id_Pagador = @Id_Pagador, Id_Favorecido = @Id_Favorecido, Id_Forma_Pagamento = @Id_Forma_Pagamento WHERE Id = @Id");
    ...
    private Pagamento CreatePagamento(SqlDataReader reader)
    {
        var pagamento = new Pagamento
        {
            ...
            Pagador = pessoaRepository.Get(reader.GetInt32(1)),
            Favorecido = pessoaRepository.Get(reader.GetInt32(2)),
            FormaPagamento = formaPagamentoRepository.Get(reader.GetInt32(3))
        };
