...
CREATE TABLE Produtos(
    ...
    Id_Unidade INT FOREIGN KEY REFERENCES Tipos_Unidades(Id)
)
...
CREATE TABLE Pagamentos(
    Id INT PRIMARY KEY IDENTITY,
	Id_Forma INT FOREIGN KEY REFERENCES Formas_Pagamento(Id),
	Valor INT NOT NULL,
...
CREATE TABLE Transacoes(
    Id INT PRIMARY KEY IDENTITY,
	Id_Pagamento INT FOREIGN KEY REFERENCES Pagamentos(Id),
	Id_Status INT FOREIGN KEY REFERENCES Status_Venda(Id),
...
CREATE TABLE Contas_Pagar(
    Id INT PRIMARY KEY IDENTITY,
    Id_Conta INT FOREIGN KEY REFERENCES Contas(Id),
)
